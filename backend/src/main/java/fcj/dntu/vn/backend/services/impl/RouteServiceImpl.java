...
public class RouteServiceImpl implements RouteService {
    ...
    public ResponseEntity<ApiResponse<List<RouteOnlyDto>>> getAllRoutes() {
        RouteService self = applicationContext.getBean(RouteService.class);
        List<RouteOnlyDto> routeDtos = self.getAllRoutesData();
    ...
    public ResponseEntity<ApiResponse<RouteDto>> getRouteById(UUID id) {
        RouteService self = applicationContext.getBean(RouteService.class);
        Object cachedData = self.getRouteByIdData(id);

        RouteDto routeDto;
        if (cachedData instanceof RouteDto) {
            routeDto = (RouteDto) cachedData;
    ...
    @Override
    @CacheEvict(value = "routes", key = "'all_routes'")
    ...
    @Transactional
    @Override
    @CacheEvict(value = { "routes", "route", "routesByName", "stops",
    ...
    @Override
    @Cacheable(value = "stops", key = "#routeId.toString() + '-' + #direction")
    ...
    @Override
    @Cacheable(value = "timelines", key = "#routeId.toString() + '-' + #direction")
